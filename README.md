...
* Don’t forget to stage your changes New users often edit files but forget to stage them with:
```
git add .
```
...
*  Affordable
*   deal for a personal site or resume-style domain.
.
net, .org, others
...
By learning the basics of repositories, branching, syncing changes, and secure authentication, you
